 ...
 * @author Admin
 */
public class Player_ver_end2 extends Actor_ver_end{
    ...
    public Player_ver_end2(int indexActor,String listBaiDuocChia,int xclock,int yclock,
        ...
        int solabaiconlai,int toadoX3bich,int toadoY3bich,String chedochoi) {
        ...
        public void taoNutRaBai()
        {
            ...
            URL url = Player_ver_end2.class.getResource("/ima_TLMN/rabai.png");
        ...
        public void taoNhanRaBaiAn()
        {
            ...
            setLayout(null);//cần phải dùng để thay đổi vị trí
            URL url = Player_ver_end2.class.getResource("/ima_TLMN/rabaian.png");
            ImageIcon icon = new ImageIcon(url);
        ...
        public void taoNutKhongTheo()
        {
            ...
            setLayout(null);//cần phải dùng để thay đổi vị trí
            URL url = Player_ver_end2.class.getResource("/ima_TLMN/khongtheo.png");
            ImageIcon icon = new ImageIcon(url);
        ...
        public void xuLyRaBai(Player_ver_end2 player)
        {
            strbaivuachon="";
...

            {
                ...
                if(theyCard.size()==0)
                {
                    ...
                    NaiveBayes_player_tranningData_ditruoc_ver_end2 ml_naivebays_pl=
                            new NaiveBayes_player_tranningData_ditruoc_ver_end2(player);
                    //turn on tranning
                    try {
                        ml_naivebays_pl.run();
      ...
      khỏi danh sách bài còn lại*/
        ...
        {
            URL url = Player_ver_end2.class.getResource("/ima_TLMN/newgame.png");
            ImageIcon icon = new ImageIcon(url);
            setLayout(null);
        ...
        {
            URL url = Player_ver_end2.class.getResource("/ima_TLMN/backhome.png");
            ImageIcon icon = new ImageIcon(url);
            setLayout(null);
        ...
        {
            URL url = Player_ver_end2.class.getResource("/ima_TLMN/sound_on.png");
            ImageIcon icon = new ImageIcon(url);
            setLayout(null);
        ...
        {
            URL url = Player_ver_end2.class.getResource("/ima_TLMN/sound_off.png");
            ImageIcon icon = new ImageIcon(url);
        ...
        {
            URL url = Player_ver_end2.class.getResource("/ima_TLMN/hoi.png");
            ImageIcon icon = new ImageIcon(url);
            setLayout(null);
