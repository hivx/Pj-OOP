    ...
    for(int i=1;i<=13;i++)
{
 ...
 public boolean checkXuoivsXuoiNguocvsNguocViTriLQToiSanh(int i)
 {
     for(int j=i;j<=13;j++)
     {
         for(int t=i;t<=13;t++)
         {
             ////////System.out.println(" "+(lamTronLen((float)baiconlaicuatoi[j]/4)-lamTronLen((float)baiconlaicuatoi[i]/4)));
     ...
     {
        // //////System.out.println("check xuoi "+i+" la thuoc sanh");
         return true;
     }  
     }
     }
      ...
      for(int j=i;j<=13;j++)
     {
        ...
        if(baiconlaicuatoi[j]<=48&&lamTronLen((float)baiconlaicuatoi[j]/4)-lamTronLen((float)baiconlaicuatoi[i]/4)==1 
         ...
         {
      //   //////System.out.println("check xuôi và ngược"+i+" la thuoc sanh");
         return true;
         }
       }
      ...
      for(int j=i;j>=1;j--)
     {
        ...
        if(baiconlaicuatoi[i]<=48&&lamTronLen((float)baiconlaicuatoi[i]/4)-lamTronLen((float)baiconlaicuatoi[j]/4)==1 
         ...
         {
         ////////System.out.println("check nguoc "+i+" la thuoc sanh");
         return true;
         }
       }
     }
...
void ToHopBaConva3or4DoiThong (int i)  {
 ...
 public boolean baiCoLucPheBon()
 {
     ...
     for(int i=0;i<cardbot.size();i++) 
      ...
      {
if(indexactor==1)dapantoitrang=cardbot.get(i).daycard;
else dapantoitrang=cardbot.get(i).sola+"$"+cardbot.get(i).loaibai+"$"
+cardbot.get(i).daycard; return true;
      }
      }
     return false;
 }
...
public void xayDungDataCacLoaiBoBaiChoBot()
{
           ...
           {
          //////System.out.println("*"+chuoitohopdacbiet3convs3or4dt[i]);
           }*/
              for(int i=1;i<=countohopdacbiet3convs3dtor4dthople;i++)
              {
