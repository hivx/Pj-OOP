 ...
 * @author Admin
 */
public class NaiveBayes_player_tranningData_ditruoc_ver_end2 {
Player_ver_end2 player;
String thongbaokieubairahople;
    ArrayList danhsachkieubaixacsuat=new ArrayList();
    private static final int SO_COT = 13;
     boolean NOT_LEARNED;
    public NaiveBayes_player_tranningData_ditruoc_ver_end2(Player_ver_end2 player) {
        this.player=player;
