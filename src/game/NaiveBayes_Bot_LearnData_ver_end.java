...
public class NaiveBayes_Bot_LearnData_ver_end {
    ...
    public void run() throws IOException {
        ...
        int sumMyCard = 0, dodaisanhmax = 0, tong2vaA = 0, tonglabaiovitridacbiettoptren = 0, countDB = 0, sumTuyenTren = 0, sumTuyenDuoi = 0, countDOIdoclap = 0, countALLDOI = 0, countBACONdoclap = 0,
        ...
        for (int i = 0; i < bot.mycard.size(); i++) {
            ...
            if (i >= bot.mycard.size() - lamTronLen((float) bot.mycard.size() / 4))
                sumTuyenTren += bot.mycard.get(i).sohieu;
        }
