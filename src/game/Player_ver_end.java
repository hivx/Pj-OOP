...
public class Player_ver_end extends Actor_ver_end {
    ...
    ArrayList<Card_Player_ver_end> baiplayervuachon = new ArrayList<>();
    ...
    public void batOptionPlayer() {
        for (Card_Player_ver_end cardPlayerVerEnd : baivuachon) {
            int j = cardPlayerVerEnd.vitri;
