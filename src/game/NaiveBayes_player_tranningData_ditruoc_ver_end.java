...
public class NaiveBayes_player_tranningData_ditruoc_ver_end {
    ...
    public void run() throws IOException {
        ...
        int dodaisanhmax = 0, countDB = 0, sumTuyenTren = 0, sumTuyenDuoi = 0, countDOIdoclap = 0, countALLDOI = 0, countBACONdoclap = 0,
                countBaiLe = 0, count3con = 0, countTuQuy = 0, countBaDoiThong = 0, countBonDoiThong = 0, sumDoiMax = 0, sumDoiMin = 0,
        ...
        for (int i = 0; i < tongsolaplayer; i++) {
            ...
            if (i >= player.mycard.size() - lamTronLen((float) player.mycard.size() / 4))
                sumTuyenTren += player.mycard.get(i).sohieu;
        }
        ...
        if (countTuQuy == 0 && countBaDoiThong == 0 && countBonDoiThong == 0) {
            eleCot[8] = "ko";
        } else eleCot[8] = "co";
